...
## Phase 5 — UK curriculum, Further Maths & A-levels — ✅ shipped in PRs #8–#11

1. **UK/US school systems** — UK is the default; families pick their system at signup (or switch it in parent settings). Grades stay stored as plain numbers; the curriculum decides how they read ("5" → "5th grade" or "Year 5") and which are on offer (US grades 3–8, UK Years 3–13).
